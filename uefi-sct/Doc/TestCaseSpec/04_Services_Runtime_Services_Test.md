...
variable.
2. Call GetVariable()
service with Data = NULL and DataSize =0 to get the test variable
 <em>Attributes</em>. The
returned status must be
EFI_SUCCESS, and the
returned <em>Attributes</em> must be
same as the attributes set
before.</td>
</tr>
</tbody>
</table>
...
## Secure Boot Runtime Services Test
